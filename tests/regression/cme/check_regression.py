"""
tests/regression/cme/check_regression.py

Regression checker for the CME Globex cleaning pipeline.
...
Usage:
    ...
    python tests/regression/cme/check_regression.py

    # Quick mode — compare existing outputs, no pipeline re-run
    python tests/regression/cme/check_regression.py --skip-pipeline

    # Single product, verbose output
    python tests/regression/cme/check_regression.py --product ES --verbose
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run regression checks on the CME cleaning pipeline."
    )
    parser.add_argument(
        "--product",
...
def main() -> int:
    ...
    print(f"{BOLD}CME Pipeline — Regression Check{RESET}")
